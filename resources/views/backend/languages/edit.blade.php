                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select
                                        class="form-select ot-input select2 @error('flagIcon') is-invalid @enderror"
                                    ...
                                    <div class="input-check-radio">
                                        <div class="form-check d-flex align-items-center">
                                            <input type="radio" class="form-check-input mt-0 mr-4 read common-key"
                                                ...
                                                {{ $data['language']->direction == App\Enums\Direction::RTL ? 'checked' : '' }}>
                                    ...
                                    <div class="input-check-radio">
                                        <div class="form-check d-flex align-items-center">
                                            ...
                                            <input type="radio" class="form-check-input mt-0 mr-4 read common-key"
                                                ...
                                                {{ $data['language']->direction == App\Enums\Direction::LTR ? 'checked' : '' }}>
                                            <label class="custom-control-label"
